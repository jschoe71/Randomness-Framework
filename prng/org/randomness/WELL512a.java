...
final class WELL512a extends WELLBase {
	...
	private int generate32() {
		...
		final int z3 = z1 ^ z2;
		final int z4 = (z0 ^ (z0 << 2)) ^ (z1 ^ (z1 << 18)) ^ (z2 << 28)
				^ (z3 ^ ((z3 << 5) & 0xda442d24));
	...
	public final int read(LongBuffer longBuffer) {
		...
		for (int longs = 0; longs < numLongs;) {
			...
			// ///////////////// GENERATE FUNCTION /////////////////////
			{
				...
				final int z2 = vi2 ^ (vi2 >>> 11);
				final int z3 = z1 ^ z2;
				final int z4 = (z0 ^ (z0 << 2)) ^ (z1 ^ (z1 << 18))
						^ (z2 << 28) ^ (z3 ^ ((z3 << 5) & 0xda442d24));
