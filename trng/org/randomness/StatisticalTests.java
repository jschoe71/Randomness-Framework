...
/**
 * Couple of statistical tests for verifying (P)RNG output as defined in FIPS
 * 140-1.
 * 
 * <p>
 * See <a href="http://www.itl.nist.gov/fipspubs/fip140-1.htm">
 * http://www.itl.nist.gov/fipspubs/fip140-1.htm</a>
 * </p>
 * 
...
/* package */final class StatisticalTests {
	...
	private static final int[] ONE_COUNT = { 0, 1, 1, 2, 1, 2, 2, 3, 1, 2, 2,
			3, 2, 3, 3, 4 };
	 ...
	 * 
	 * @param data
	 *            2500 bytes (20,000 bits) of data to be tested
	 * @return true if the data 'looks random'
	 * @throws IllegalArgumentException
	 *             when not 2500 bytes are input
	 */
